  ...
  return (
    <div>
      <AppContainer1>
        <div
          id="contact"
          className="bg-darkblue rounded-2xl xl:mt-40 md:mt-40 sm:mt-60 h-[472px] w-full lg:pt-36 lg:px-48 md:px-28 sm:px-5  flex flex-col items-center justify-center text-center "
        >
