  ...
  return (
    <AppContainer1>
          <div className=" flex xl:flex-row sm:flex-col items-center justify-between gap-5 font-ver text-black my-8">
            ...
            <nav className="">
              <ul className=" sm:text-center lg:grid md:grid lg:grid-cols-2 md:grid-cols-2 uppercase xl:gap-12 md:gap-14 xl:text-xl md:text-sm font-ver font-normal text-darkblue cursor-pointer">
